              ...
              <!-- Custom Tabs -->
                ...
                <div class="box-body">
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												<th style="color:white;" bgcolor="#3c8dbc" >Título</th>
												<th style="color:white;" bgcolor="#3c8dbc">Fecha de creación</th>
										...
										<tbody>
											<jstl:forEach var="x" items="${estudios}">
												<tr>
													...
													<td><jstl:if test="${x.algoritmo != 'Máquina de soporte vectorial' && x.algoritmo != 'Regresión Lineal'}">
