          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <jstl:if test="${estudio.algoritmo == 'Árbol de decisión'}">
                  <h3 class="box-title">Grafo del estudio</h3>
                  </jstl:if>
                  
                  <jstl:if test="${estudio.algoritmo == 'Subgroup Discovery'}">
                  <h3 class="box-title">Premisas del modelo</h3>
                  </jstl:if>
                  
                  <jstl:if test="${estudio.algoritmo == 'Máquina de soporte vectorial'}">
                  <h3 class="box-title">Datos del modelo</h3>
                  </jstl:if>
                  
                 <jstl:if test="${estudio.algoritmo == 'Regresión Lineal'}">
                  <h3 class="box-title">Datos del modelo</h3>
                  </jstl:if>
                </div><!-- /.box-header -->
                <!-- form start -->
...
<%--   					<iframe class="embed-responsive-item" src="http://10.232.0.145:8080/RA/public_process/newService?ruta=C%3A%5CDocuments+and+Settings%5Cesalud%5CMis+documentos%5CFTP%5C${estudio.path}&objetivo=${estudio.label}&atributos=${atributos}&amp;width=800&amp;height=600" width="400" height="350" scrolling="no"></iframe> --%>
<!-- 				</div> -->
									<jstl:if test="${estudio.algoritmo != 'Subgroup Discovery'}">
				                 								
								
				<div class="embed-responsive embed-responsive-16by9">
  					<iframe class="embed-responsive-item" src="http://10.232.0.145:8080/RA/public_process/ReadModel?ruta=C%3A%5CDocuments+and+Settings%5Cesalud%5CMis+documentos%5CFTP%5C${estudio.path2}&amp;width=800&amp;height=600" width="400" height="350" scrolling="no"></iframe>
				</div>
				</jstl:if>
              </div><!-- /.box -->
            </div><!-- /.col -->
