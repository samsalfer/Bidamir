                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <jstl:if test="${estudioForm.tipe == 'asociacion'}">
													<input class="form-control" id="tipo" readonly="true" value="Asociación"></jstl:if>
					<jstl:if test="${estudioForm.tipe == 'clasificacion'}">
													<input class="form-control" id="tipo" readonly="true" value="Predicción"></jstl:if>
                      ...
                      <input type="file" class="filestyle" id="input" name="file" id="blah" onchange="readURL(this);">
	                    ...
	                    <div class="form-group">
	                      ...
	                      <form:select path="algoritmo" class="form-control">
	                        ...
	                        <option>Máquina de soporte vectorial</option>
	                      </form:select>
	                    </div>
	                    </jstl:if>
					...
					<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <b><u>Clasificación</u></b><br><br>
					       <b>Árbol de decisión:</b> técnica predictiva (clasificación) en la que de forma jerárquica (árbol) se plantean sucesivas decisiones sobre las variables, hasta llegar a un resultado final de predicción.<br><br>

							<b>Máquina de soporte vectorial: </b>  se clasifica mediante un conjunto de hiperplanos en un espacio de alta dimensionalidad. Una buena separación entre las clases permitirá un clasificación correcta.<br><br>
						  <b><u>Asociación</u></b><br><br>
							<b>Subgroup Discovery:</b> obtención de subgrupos (reglas) con propiedades estadísticamente interesantes, con una distribución estadística inusual respecto a cierta propiedad de interés.<br><br>
					      </div>
