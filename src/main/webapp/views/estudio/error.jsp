    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
                    <h1><span class="fa fa-bomb"></span>
            Error
			    </h1>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i> Error</li>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Hubo un fallo mientras se creaba un estudio</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
              ...
              <!-- Custom Tabs -->
                ...
                <div class="box-body">
                 <div class="alert alert-danger alert-dismissable">
                    ...
                    El estudio no ha podido ser creado correctamente, debido a que el documento excel utilizado no cumple las condiciones que necesita el algoritmo seleccionado. 
                  </div>
