            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Seleccione un tipo de estudio</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
           ...
           <div class="col-md-12">
              <!-- Custom Tabs -->
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                	  <button class="btn btn-block btn-primary btn-lg" onclick="javascript: window.location.replace('user/estudio/create.do?type=clasificacion')">Predicción</button>
	                  <div class="box box-solid">
		                <div class="box-header with-border text-center">
		                  <h3 class="box-title" >Algoritmos de predicción</h3>
		                </div><!-- /.box-header -->
		                <div class="box-body text-center">
		                  <p>Predicen una variable discreta, basándose en otros atributos del conjunto de datos.</p>
                  ...
                  <div class="col-md-6">
                	  <button class="btn btn-block btn-primary btn-lg" onclick="javascript: window.location.replace('user/estudio/create.do?type=asociacion')" >Asociación</button>
                  	  <div class="box box-solid">
		                <div class="box-header with-border text-center">
		                  <h3 class="box-title" >Algoritmos de asociación</h3>
		                </div><!-- /.box-header -->
		                <div class="box-body text-center">
		                  <p>buscan relaciones entre las variables de un conjunto de datos, generalmente en forma de reglas.</p>
