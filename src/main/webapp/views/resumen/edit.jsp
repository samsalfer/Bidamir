          ...
          <div class="row">
            ...
            <div class="col-md-12">
 			...
 			<div class="box box-primary">
                ...
                <!-- form start -->
                <form:form action="user/resultado/create.do" enctype="multipart/form-data" method="post" modelAttribute="resultadoForm">
                  <form:hidden path="estudioId"/>
                  
                  <div class="box-body">
					<div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#tab_1" data-toggle="tab">Predicción Simple</a></li>
                  <li><a href="#tab_2" data-toggle="tab">Predicción Múltiple</a></li>
                  
                 
                </ul>
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                  <p class="help-block">Añada los campos seleccionados para poder aplicar un estudio.</p>
     				...
     				<jstl:forEach items="${listaAtributosSinObjetivo}" var="atributo">
                      ...
                      <form:input class="form-control" id="datosap" path="datosAPredecir[${contador}]" />
                    </div>
                  ...
                  <div class="tab-pane" id="tab_2">
                   <div class="form-group">
                     ...
                     <p class="help-block">Puede realizar varias consultas a la vez si los datos han sido estructuradas en un excel de la misma forma.</p>
                    </div>
                  </div><!-- /.tab-pane -->
                  ...
                  <div class="box-footer">
                  	<acme:submit name="save" code="estudio.save"/>
