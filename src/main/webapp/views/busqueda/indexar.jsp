...
n-->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
            	...
            	<li class="active"><a class="fNiv" href="user/busqueda/indexar.do"><i class="fa fa-circle-o"></i> Indexar Documentos</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i> Búsqueda</li>
            ...
            <div class="col-md-12">
 			...
 			<div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Documento XML</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form:form action="user/busqueda/indexar.do" enctype="multipart/form-data" method="post" modelAttribute="indexarForm"> 
                 
                  <div class="box-body">
                      <div class="form-group">
                      Con esta opción podrá añadir al repositorio de búsquedas nuevos documentos contenidos en un archivo XML.<br><br>
                      <label for="input">Documento </label><i class="fa  fa-question-circle"  data-toggle="tooltip" title="Seleccione un documento XML para agregarlo al índice de búsquedas"></i>
                  ...
                  <div class="box-footer">
					<acme:submit name="indexar" code="estudio.indexar" />
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-md-12">
 			...
 			<div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Eliminar Índice</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form:form action="user/busqueda/indexar.do" method="post" modelAttribute="busquedaForm">
                 
                  <div class="box-body">
                      <div class="form-group">
                      Puede eliminar el índice actual para poder crear un nuevo índice de búsquedas.
                      </div>
		                         
                  </div><!-- /.box-body -->

                  <div class="box-footer">
					<acme:submit name="eliminarIndex" code="resumen.eliminar" onclick="return confirm('Si pulsa aceptar borrará todo el índice creado. ¿Está de acuerdo?')"/>
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        ...
			        <div class="modal-body">
			          <span ><spring:message code="${message2}" /></span>
			        </div>
