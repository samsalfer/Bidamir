            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Presentación BIDAMIR</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
           ...
           <div class="col-md-12">
              <!-- Custom Tabs -->
                ...
                <div class="box-body">
                  <dl>
                    <dt>Descripción</dt>
                    <dd>BIDAMIR (BIomedical DAta Mining and Information Retrieval) es un sistema de información clínico, que permitirá acceder, de forma inteligente, a la información textual y extraer conocimiento de utilidad desde las fuentes de datos estructuradas.</dd>
                    <dt>Datos del proyecto</dt>
                    <dd>Investigador Principal: Jacinto Mata Vázquez.</dd>
                    <dd>Cuantía de la subvención: 96.916,25 euros</dd>
                    <dd>Entidad financiadora: Consejería de Economía, Innovación y Ciencia. Junta de Andalucía</dd>
