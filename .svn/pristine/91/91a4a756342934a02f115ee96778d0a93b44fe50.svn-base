    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a class="fNiv" href="user/resumen/list.do"><i class="fa fa-circle-o"></i> Mis Resúmenes</a></li>
              </ul>
            </li>
            </security:authorize>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i> Resúmenes</li>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Mis resúmenes</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th style="color:white;" bgcolor="#3c8dbc">Número de sentencias</th>
												<th style="color:white;" bgcolor="#3c8dbc">Número de palabras</th>
											...
											<jstl:forEach var="x" items="${resumenes}">
												<tr>
													...
													<td><i class="fa fa-trash-o"></i> &nbsp;&nbsp;<a
															...
															onclick="return confirm('¿Estás seguro de que quieres eliminar este estudio?')">Eliminar</a></td>
