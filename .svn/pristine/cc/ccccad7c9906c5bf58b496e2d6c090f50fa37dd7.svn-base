              ...
              <!-- Custom Tabs -->
                ...
                <div class="box-body no-padding">
                  <table class="table table-condensed">
                    ...
                    <tr>
                      <td>1.</td>
                      <td class="col-md-5">Una vez pulse el botón finalizar comenzará a crearse el estudio.</td>
                      <td class="col-md-7">
                    ...
                    <tr>
                      <td>3.</td>
                      <td>Si algún dato no es compatible aparecerá una pantalla de error.</td>
                      <td>
