            ...
            <div class="col-md-12">
 			...
 			<div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Detección de la negación</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form:form action="user/negacion/edit.do" enctype="multipart/form-data" method="post" modelAttribute="negacionForm">
                  ...
                  <div class="box-body">
	                ...
	                <form:textarea class="form-control" rows="8" id="texto" path="texto"/>
					<div class="form-group">
                      <label for="input">Documento </label><i class="fa  fa-question-circle"  data-toggle="tooltip" title="Seleccione un documento TXT para agregarlo como texto"></i>
                  ...
                  <div class="box-footer">
		          	 <acme:submit name="subir" code="resumen.subir"/>
                     <input type="button" name="cancel" value="Detectar" 
	onclick="javascript: window.location.replace('user/negacion/display.do')" class="btn btn-primary"/>
