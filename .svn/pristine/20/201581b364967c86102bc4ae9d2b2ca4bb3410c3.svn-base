                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab_2">
                   <div class="form-group">
                     ...
                     <p class="help-block">Puede elegir la opción de predicción múltiple, seleccionando un excel que contenga los mismos atributos que contiene el excel con el que creó el estudio.</p>
                    </div>
                  </div><!-- /.tab-pane -->
